            ...
            <div className="flex gap-4 mb-10">
              {socialLinks.map((social) => (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-12 h-12 bg-neutral-900 border border-neutral-800 flex items-center justify-center transition-all duration-300 shadow-lg group/icon"
                  style={{ color: social.brandColor }}
                  aria-label={social.name}
                >
                  <div className="group-hover/icon:scale-125 transition-transform drop-shadow-[0_0_8px_rgba(0,0,0,0.5)]">
                    {social.icon}
                  </div>
                </a>
              ))}
